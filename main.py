...
if __name__ == "__main__":
    ...
    pick_andons = session.download_csv('http://fc-andons-na.corp.amazon.com/HDC3?category=Pick&type=All+types', '/html/body/div/div/div/awsui-app-layout/div/main/div/div[2]/div/span/div/awsui-table/div/div[2]/div[1]/div[1]/span/div/div[2]/awsui-button[1]/button', r"C:\Users\nuneadon.ANT\Downloads")
    CC_andons = session.download_csv('http://fc-andons-na.corp.amazon.com/HDC3?category=Bin+Item+Defects&type=All+types', '/html/body/div/div/div/awsui-app-layout/div/main/div/div[2]/div/span/div/awsui-table/div/div[2]/div[1]/div[1]/span/div/div[2]/awsui-button[1]/button', r'"C:\Users\nuneadon.ANT\Downloads"')
...
try:
    ...
    fclm_hours = int(websites[FCLM]['total-paid-hours']['total'])
    ...
    print(f"HC MDPReject: {unit_MDPReject}")
    print(f"HC TransDelete: {unit_TransDELETE}")
